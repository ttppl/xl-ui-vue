<template>
  <teleport to="body">
    <transition :name="transition">
      <div v-show="showPopup" ref="content" class="xl-popup-content" :style="style" :class="classes">
        ...
        <svg v-if="showClose" @click="showPopup=false" :style="{zIndex:zIndex+2}" class="xl-close-icon" t="1630307589611" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4768" width="20" height="20"><path d="M557.312 513.248l265.28-263.904c12.544-12.48 12.608-32.704 0.128-45.248-12.512-12.576-32.704-12.608-45.248-0.128l-265.344 263.936-263.04-263.84C236.64 191.584 216.384 191.52 203.84 204 191.328 216.48 191.296 236.736 203.776 249.28l262.976 263.776L201.6 776.8c-12.544 12.48-12.608 32.704-0.128 45.248 6.24 6.272 14.464 9.44 22.688 9.44 8.16 0 16.32-3.104 22.56-9.312l265.216-263.808 265.44 266.24c6.24 6.272 14.432 9.408 22.656 9.408 8.192 0 16.352-3.136 22.592-9.344 12.512-12.48 12.544-32.704 0.064-45.248L557.312 513.248z" p-id="4769" :fill="iconColor"></path></svg>
        <div class="xl-popup-content-title">
          <slot name="title" />
        </div>
        <SpScroll :show-scroll="showScroll">
          <slot />
        </SpScroll>
  ...
  computed: {
    ...
    transition () {
      switch (this.direction) {
        ...
        case 'left':
          return 'tst-popup-scale-right'
        case 'right':
          return 'tst-popup-scale-left'
        case 'top':
          return 'tst-popup-scale-down'
        case 'bottom':
          return 'tst-popup-scale-up'
        default:
          return 'tst-popup-scale-center'
      }
    },
...
.xl-popup-content{
  ...
  min-height: 20%;
  opacity: 1;
  .xl-popup-content-title, .xl-popup-content-footer{
    margin:0 auto;
  }
  overflow: hidden;
  >.xl-close-icon{
...
.tst-popup-scale-down-enter-active,
.tst-popup-scale-down-leave-active {
  opacity: 1;
  left:50%;
...
.tst-popup-scale-down-enter-from,
.tst-popup-scale-down-leave-to {
  opacity: 0;
  left:50%;
...
.tst-popup-scale-up-enter-active,
.tst-popup-scale-up-leave-active {
  opacity: 1;
  left:50%;
  -webkit-transform: translateX(-50%) scaleY(1) !important;
  transform: translateX(-50%) scaleY(1) !important;
...
.tst-popup-scale-up-enter-from,
.tst-popup-scale-up-leave-to {
  opacity: 0;
  left:50%;
  -webkit-transform: translateX(-50%) scaleY(0) !important;
  transform: translateX(-50%) scaleY(0) !important; 
...
.tst-popup-scale-right-enter-active,
.tst-popup-scale-right-leave-active {
  opacity: 1;
  top:50%;
...
.tst-popup-scale-right-enter-from,
.tst-popup-scale-right-leave-to {
  opacity: 0;
  top:50%;
...
.tst-popup-scale-left-enter-active,
.tst-popup-scale-left-leave-active {
  opacity: 1;
  top:50%;
  -webkit-transform: translateY(-50%) scaleX(1) !important;
  transform: translateY(-50%) scaleX(1) !important;
...
.tst-popup-scale-left-enter-from,
.tst-popup-scale-left-leave-to {
  opacity: 0;
  top:50%;
  -webkit-transform: translateY(-50%) scaleX(0) !important;
  transform: translateY(-50%) scaleX(0) !important; 
